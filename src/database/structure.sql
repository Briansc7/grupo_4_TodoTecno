...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`roles` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`users` ;
...
-- -----------------------------------------------------
-- Table `Todo_Tecno`.`user_copy1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`user_copy1` ;

CREATE TABLE IF NOT EXISTS `Todo_Tecno`.`user_copy1` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`categories` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`subCategories` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`brands` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`products` ;
...
CREATE TABLE IF NOT EXISTS `Todo_Tecno`.`products` (
  ...
  `discount` TINYINT UNSIGNED NULL DEFAULT 0,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`stores` ;
...
CREATE TABLE IF NOT EXISTS `Todo_Tecno`.`stores` (
  ...
  `description` TEXT NULL,
  `shoppingHours` VARCHAR(45) NOT NULL,
  `createdAt` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL,
  `deletedAt` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`statusStock` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`stock` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`discountCupons` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`statusSales` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`InterestOptions` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`paymentMethods` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`sales` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`detailSales` ;
...
CREATE TABLE IF NOT EXISTS `Todo_Tecno`.`detailSales` (
  ...
  `saleDiscount` DECIMAL(10,2) UNSIGNED NOT NULL DEFAULT 0,
  `createdAt` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL,
  `deletedAt` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`productImages` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`characteristics` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Todo_Tecno`.`subCharacteristics` ;
